...
const PurchaseReport: React.FC = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      {/* Filter Bar Section */}
      <div className="flex flex-wrap items-center justify-end gap-2 bg-white/50 p-2 rounded">
        {/* Items Dropdown */}
        ...
        <div className="relative">
          <input 
            ...
            className="appearance-none bg-white border border-gray-200 rounded px-3 py-1.5 text-[11px] text-gray-600 font-medium outline-none focus:border-[#2d808e] transition-all pr-8"
          />
      ...
      <div className="flex justify-end">
        <button 
          ...
          className="flex items-center space-x-1.5 border border-[#2d808e] bg-white px-3 py-1 rounded text-[11px] font-bold text-gray-700 hover:bg-gray-50 transition-all shadow-sm"
        >
          ...
          <table className="w-full text-left border-collapse min-w-[1400px]">
            <thead className="bg-white">
              <tr className="text-[10px] font-bold text-gray-800 border-b border-gray-100">
                <th className="px-4 py-3 text-center w-12 border-r border-gray-50">SL</th>
                <th className="px-4 py-3 text-left w-32 border-r border-gray-50">Tnx. Date</th>
                <th className="px-4 py-3 text-left w-32 border-r border-gray-50 relative">
                  Tnx. Type
                ...
                <th className="px-4 py-3 text-left w-48 border-r border-gray-50 relative">
                  Name
                  <Filter size={10} className="inline-block ml-1 text-gray-300" />
                </th>
                <th className="px-4 py-3 text-center w-24 border-r border-gray-50">UOM</th>
                <th className="px-4 py-3 text-right w-32 border-r border-gray-50">Unit Price</th>
                <th className="px-4 py-3 text-center w-20 border-r border-gray-50">Qty</th>
                <th className="px-4 py-3 text-right w-32 border-r border-gray-50">Trnx. Value</th>
                <th className="px-4 py-3 text-center w-24 border-r border-gray-50">Status</th>
                <th className="px-4 py-3 text-center w-32 border-r border-gray-50">Created By</th>
                <th className="px-4 py-3 text-center w-32">Updated By</th>
              </tr>
            </thead>
            <tbody>
              {reportData.length > 0 ? (
                reportData.map((row, idx) => (
                  <tr key={idx} className="border-b border-gray-50 text-[10px]">
                    {/* Data mapping here */}
                  </tr>
                ))
              ) : (
