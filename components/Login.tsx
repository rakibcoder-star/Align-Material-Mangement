    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f4f7f6] font-sans overflow-hidden relative" style={{ fontFamily: 'var(--ant-font-family)' }}>
      ...
      <div className="w-full max-w-[440px] bg-white rounded-3xl shadow-[0_32px_80px_rgba(0,0,0,0.06)] p-10 flex flex-col items-center animate-slide-up relative border border-white/20 backdrop-blur-sm z-10">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="text-4xl font-black text-[#2d808e] tracking-tighter mb-0.5 italic">ALIGN</h1>
          <p className="text-[10px] font-black text-gray-300 uppercase tracking-[0.4em] ml-1">Enterprise terminal</p>
        </div>
        ...
        {errorMsg && (
          <div className="w-full mb-6 p-3.5 bg-red-50 border border-red-100 rounded-xl flex items-start space-x-3 text-red-600 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div className="flex flex-col">
              <span className="text-[11px] font-black leading-tight">{errorMsg}</span>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          ...
          <div className="flex items-center justify-between px-1 pt-1">
            ...
            <button type="button" className="text-[11px] font-black text-[#2d808e] hover:underline uppercase tracking-tight">Recovery</button>
          </div>

          <button
            type="submit"
            disabled={loading}
            className="w-full py-4.5 mt-3 bg-[#2d808e] text-white font-black text-[13px] uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-[#2d808e]/10 transition-all hover:bg-[#256b78] hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-70 flex items-center justify-center space-x-3"
          >
        ...
        <div className="mt-12 text-center">
          <p className="text-[9px] text-gray-300 font-black uppercase tracking-[0.4em]">Proprietary Data Node</p>
        </div>
      </div>
    </div>
  );
